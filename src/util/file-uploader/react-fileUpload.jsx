...
class FileUpload extends React.Component {
  ...
  _updateProps(props) {
    ...
    this.dataType = "json";
    options.dataType &&
      options.dataType.toLowerCase() == "text" &&
      (this.dataType = "text");
  ...
  /*打包render函数*/
  _packRender() {
    /*IE 用 iframe 表单上传，其他用ajax Formdata*/
    let render = "";
    if (this.isIE) {
      ...
      render = (
        <div className={this.props.className} style={this.props.style}>
          {this.state.before}
          <div
            onClick={e => this.commonChooseFile(e)}
            style={{
              overflow: "hidden",
              postion: "relative",
          ...
          <input
            ...
            style={{ display: "none" }}
            onChange={e => this.commonChange(e)}
            {...restAttrs}
          />
        </div>
      );
    ...
    function _insertIEForm(formArr, i) {
      ...
      const input = (
        <input
          ...
          onChange={e => this.IEChooseFile(e)}
